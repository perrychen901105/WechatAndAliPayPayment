...
//    UITextView* textView = [[[UITextView alloc] initWithFrame:CGRectMake(10, 285, 145, 40)] autorelease];
//    textView.tag = 10001;
...
//    [footView addSubview:textView];
    ...
    [btn11 setTitle:@"测试url长度" forState:UIControlStateNormal];
    btn11.titleLabel.font = [UIFont systemFontOfSize:14];
    [btn11 setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [btn11 setFrame:CGRectMake(10, 285, 145, 40)];
    [btn11 addTarget:self action:@selector(testUrlLength) forControlEvents:UIControlEventTouchUpInside];
    ...
    [btn12 setFrame:CGRectMake(165, 285, 145, 40)];
    ...
    [btn13 setFrame:CGRectMake(10, 330, 145, 40)];
    ...
    [btn14 setFrame:CGRectMake(165, 330, 145, 40)];
    ...
    [btn15 setFrame:CGRectMake(10, 375, 145, 40)];
